(function($) {
    ...
    if ($(".chat-application .profile-sidebar-area .scroll-area").length > 0) {
        var chat_user_list = new PerfectScrollbar(
            ".profile-sidebar-area .scroll-area"
        );
    }
...
//solve the problem of scroll bar
document.addEventListener("DOMSubtreeModified", () => {
    // Chat user list
    if ($(".chat-application .chat-user-list").length > 0) {
        $(".chat-application .chat-user-list").addClass(
    ...
    // Chat user profile
    if ($(".chat-application .profile-sidebar-area .scroll-area").length > 0) {
        $(".chat-application .profile-sidebar-area .scroll-area").addClass(
            "ps ps-active-y ps--active-y ps--scrolling-y"
        );
    }
    ...
    // Chat area
    if ($(".chat-application .user-chats").length > 0) {
        $(".chat-application .user-chats").addClass(
            "ps ps-active-y ps--active-y ps--scrolling-y"
        );
    }
    ...
    // User profile right area
    if ($(".chat-application .user-profile-sidebar-area").length > 0) {
        $(".chat-application .user-profile-sidebar-area").addClass(
            "ps ps-active-y ps--active-y ps--scrolling-y"
        );
    }
});
