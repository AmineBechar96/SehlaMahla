                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active" data-menu=""><a class="dropdown-item"
                                            ...
                                            data-i18n="Checkout"><i class="feather icon-circle"></i>Checkout</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                            ...
                                            <div class="card border-info text-center bg-transparent">
                                                <div class="card-content">
                                                    <img src="../../../app-assets/images/elements/macbook-pro.png"
                                                        alt="element 04" width="200" class="float-center mt-3 pl-2">
                                                    <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <div class="coupons">
                                        <div class="d-flex justify-content-between coupons-title">
                                            <p class="mr-2">No</p>
                                            <p class="mr-2">NOM</p>
                                        ...
                                        <table class="table table-hover-animation mb-0 ">
                                            <thead style="border-top:none">
                                                <tr>
                                                    <th scope="1">#</th>
                                                    <th scope="1">NOM</th>
                                                    <th scope="1">QUANTITY</th>
                                                    <th scope="1">MONTANT</th>
                                                </tr>
                                            </thead>
                                        </table>
                                    </div>
