                ...
                <div class="card-content">
                    ...
                    <div class="card-body">
                        <div class="item-name">
                            ...
                            <p class="stock-status-in text-danger">{{trans('bookings.'.$booking->status)}}</p>
                        </div>
                    ...
                    <div class="item-options text-center">
                        ...
                        <div class="wishlist">
                            <a href="{{url('client/'.$booking->service->type->name.'/agency-details/'.$booking->service->id)}}"
                                style="color:#2c2c2c"> <i class="feather icon-eye align-middle"></i> CONSULTER </a>
                        </div>
                        <div class="cartt" style="color:#fff; background:#ff9f43;">
                            <a href="{{url('client/'.$booking->service->type->name.'/agency-details/'.$booking->service->id)}}"
                                style="color:#fff"> <i class="feather icon-clipboard mr-25"></i> Réserver </a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-content">
                            <div class="card-body text-center">
                                ...
                                <h1 class="font-large-2 my-1">Oups -No Content
                                    Found!</h1>
                                <p class="p-2">
                                    Vous aves aucun Réservation Réjétée , notez qu'un mauvais comportement et le manque
                                    de clarté de la description de la réservation peuvent entraîner le rejet de la
                                    réservation
