            ...
            <div class="sidebar-content email-app-sidebar d-flex">
                ...
                <div class="email-app-menu">
                    <div class="form-group form-group-compose text-center compose-btn">
                        <button type="button" class="btn btn-warning btn-block my-2" data-toggle="modal"
                            data-target="#composeForm"><i class="feather icon-clipboard"></i> List
                            Reservalistion</button>
                    </div>
                                ...
                                <div class="action-right ml-auto">
                                    <ul class="list-inline m-0">
                                        ...
                                        @if ($bookingStatus=="pending")<li class="list-inline-item mail-unread"
                                            title="Annuler"><a href="{{url('client/pending/bookings')}}"
                                        ...
                                        @elseif ($bookingStatus=="ongoing")<li class="list-inline-item mail-unread"
                                            title="Terminer"><a href="{{url('client/ongoing/bookings')}}"
                                        ...
                                        @elseif ($bookingStatus=="completed")<li class="list-inline-item mail-unread"
                                            title="Terminer"><a href="{{url('client/completed/bookings')}}"
                                        ...
                                        @elseif ($bookingStatus=="canceled")<li class="list-inline-item mail-unread"
                                            title="Terminer"><a href="{{url('client/canceled/bookings')}}"
                                ...
                                <div class="col-12">
                                    <div class="card px-1">
                                        ...
                                        <div class="card-body mail-message-wrapper pt-2 mb-0">
                                            <div class="mail-message">
                                                <p> <i class="feather icon-map-pin font-medium-3 mr-50"></i> Addresse
                                                </p>
