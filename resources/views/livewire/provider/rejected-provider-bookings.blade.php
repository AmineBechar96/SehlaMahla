<div>
                        ...
                        <div class="dropdown">
                            <fieldset class="form-group">
                                <select class="custom-select" id="dateOfNews" wire:model="date">
                                    <option class="dropdown-item" value="any">
                                        Tous
                                    </option>
            ...
            <div class="card ecommerce-card">
                <div class="card-content">
                    ...
                    <div class="item-options text-center">
                        ...
                        <div class="wishlist" wire:click="accept({{$booking->id}})">
                            <i class="feather icon-check-circle align-middle"></i> Accepter
                        </div>
                        <div class="cartt bg-warning text-white ">
                            <i class="feather icon-eye mr-25"></i> CONSULTER
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-content">
                            <div class="card-body text-center">
                                ...
                                <h1 class="font-large-2 my-1">Oups -No Content
                                    Found!</h1>
                                <p class="p-2">
                                    Vous aves aucun Réservation réjétée , notez que le refus de la réservations peut
                                    affecter votre score et votre comportement général
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <div class="detail">
                            <div class="detail-title">
                                Reservations Réjétées
                            </div>
                            <div class="detail-amt">
                                {{$number_of_bookings_rejected}}
                            </div>
                        </div>
                        ...
                        <div class="btn btn-primary btn-block place-order">VOIR PLUS</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade text-left" id="NotifyClientAccept" wire:ignore.self tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between mt-1">
                    ...
                    <button type="submit" class="text-primary font-weight-bold mr-1" style="padding: 0;
                              border: none;
                              background: none;" data-toggle="modal" data-target="#NotifyClientAccept">COMPRIS</button>
                </div>
