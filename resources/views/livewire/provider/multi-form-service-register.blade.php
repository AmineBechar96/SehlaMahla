<div>
    ...
    <form wire:submit.prevent="addService" method="POST">
        @csrf
        {{---First Form--}}
        @if ($CurrentForm==1)
            ...
            <div class="media">
                <a href="javascript: void(0);">
                    ...
                    <img src="{{$ServiceImage->temporaryUrl() }}" class="rounded mr-75" alt="profile image" height="64"
                        width="64">
                    @else
                    <img src="../../../app-assets/images/noImage.jpg" class="rounded mr-75" alt="profile image"
                        height="64" width="64">
                    @endif
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        <div class="controls">
                            <label class="font-weight-bold text-dark" for="account-username"
                                class="font-weight-bold text-dark">{{trans('create-service.service-name')}}</label>
                            ...
                            <input type="text"
                                ...
                                placeholder="Nom de Service" required>
                            @error('ServiceTitle')
                            <span class="text-danger" role="alert">
                                {{ $message }}
                            </span>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="email" id="account-gmail" name="ServiceGmail" wire:model="ServiceGmail"
                            class="form-control service-input  @error('ServiceGmail') is-invalid  @enderror"
                ...
                <div class="col-12 mb-1">
                    <label class="font-weight-bold text-dark" for="accountTextarea">
                        {{trans('create-service.service-covering-territory')}} <span class="text-muted"
                            style="font-size:10px;">(Optionel)</span></label>
                    <div class="form-group">
                        <select class="form-control service-input" wire:model="ServiceTerritory" name="ServiceTerritory"
                            id="terriSelect">
                ...
                <div class="col-12 mb-1">
                    ...
                    <div class="form-group">
                        ...
                        <a class="text-primary"
                            wire:click.prevent="showTerms">{{trans('create-service.service-terms')}}</a>
