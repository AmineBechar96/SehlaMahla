<div>
    ...
    <section id="place-order" class="list-view product-checkout">
        ...
        <div class="checkout-options">
            ...
            <div class="alert alert-danger ml-2 mr-2 mb-2" role="alert">
                <h4 class="alert-heading"><i class="feather icon-bell mr-1 align-middle"></i>
                    Coupone</h4>
                <span>
                    <strong> {{ucwords($coupons->client->name)}}</strong> a un coupon.

                    Vous pouvez l'utiliser en changeons les parameters</strong>.</span>
            </div>@endif
            <div class="card">
                <div class="card-content">
                            ...
                            <table class="table table-hover-animation mb-0 ">
                                <thead style="border-top:none" class="text-dark">
                                    <tr>
                                        ...
                                        <th class="noborder" scope="1">QUANTITY</th>
        ...
        <div class="modal fade text-left" id="unavailable" wire:ignore.self tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    <div class="modal-header  bg-transparent white"
                        ...
                        <h5 class="modal-title text-dark" id="myModalLabel120">Repture de Stock
                        </h5>
                    ...
                    <div class="modal-body text-center">
                        ...
                        <span class="text-dark font-weight-bold" id="serviceName"> Ce Produit
                            est n'est Disponible en stock</span>
                    ...
                    <div class="modal-footer justify-content-between mt-1">
                      ...
                      border: none;
                      background: none;" data-toggle="modal" data-target="#unavailable">COMPRIS</button>
                    </div>
    ...
    @else
    <section id="basic-button-icons " style="margin-top:50px;">
        <div class="row justify-content-center">
            <div class="col-lg-4 col-sm-8 ">
                <div class="card">
                    <div class="card-header justify-content-center d-flex flex-column text-center">
                        ...
                        <p>Avant de Continuer Vous Devez D'abord Ajouter Quelque Informations Necessaire Qui Sont
                            reliées a votre service </p>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <div class="row match-height">
                                <div class="col-12 text-center">
                                    ...
                                    <button type="button" class="btn btn-primary font-weight-bold mr-1 mt-2 mb-5"
                                        style="height:47px; border-radius:40px" wire:click="addNew"><i
    ...
    <div class="modal fade text-left" wire:ignore.self id="large" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <form class="form" wire:submit.prevent="{{$editMode ? 'updateParam':'saveInvoiceParameters'}}"
                    method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="text-center mb-3">
                            ...
                            @else
                            <h4 class="font-weight-bold">Ajouter Paramèters</h4>
                            @endif
                                ...
                                <div class="col-12">
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <select class="custom-select" wire:model="discountRate" style="height:41px"
                                            ...
                                            @if ($coupons)
                                            <option value="{{$coupons->discount->taux."%"}}">{{$coupons->code}}
                                            </option>
                                            @endif
                                    ...
                                    <div class="alert alert-success ml-2 mr-2 mb-2" role="alert">
                                        <h4 class="alert-heading"><i class="feather icon-star mr-1 align-middle"></i>
                                            Remarque</h4>
                                        <span>
                                            Les Reductions sont <strong> fixé</strong> a 0% par default

                                            vous pouvez ajouter des reductions et des coupounes pour votre clients
                                            fideles aprés</strong>.</span>
                                    </div>
                                    @endif
