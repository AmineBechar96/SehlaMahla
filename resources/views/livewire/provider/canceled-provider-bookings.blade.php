            ...
            <div class="card ecommerce-card">
                <div class="card-content">
                    ...
                    <div class="item-options text-center">
                        ...
                        <div class="wishlist">
                            <i class="feather icon-info align-middle"></i> Voir Motive
                        </div>
                        <div class="cartt bg-warning text-white">
                            <a href="{{url('provider/'.$booking->id.'/booking')}}" class="text-white"> <i
                                    class="feather icon-eye mr-25"></i> CONSULTER</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-content">
                            <div class="card-body text-center">
                                ...
                                <h1 class="font-large-2 my-1">Oups -No Content
                                    Found!</h1>
                                <p class="p-2">
                                    Vous aves aucun Réservation annulée , notez que répondre rapidement peut réduire le
