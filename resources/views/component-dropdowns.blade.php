                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active" data-menu=""><a class="dropdown-item"
                                            ...
                                            data-i18n="Dropdowns"><i class="feather icon-circle"></i>Dropdowns</a>
                                    </li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <div class="btn-group mb-1">
                                            <div class="dropdown">
                                                <button class="btn btn-dark dropdown-toggle mr-1" type="button"
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <p>
                                            To create a dropdown with split button use <code>.btn-outline-</code> with
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <p>To create a flat dropdown use <code>.btn-flat-*</code> with your
                                            dropdown-toggle</p>
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                <button class="btn btn-flat-primary dropdown-toggle mr-1 mb-1"
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                <button class="btn btn-flat-success dropdown-toggle mr-1 mb-1"
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                <button class="btn btn-flat-info dropdown-toggle mr-1 mb-1"
                                                    type="button" id="dropdownMenuButton300" data-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false">
                                                    Info
                                                </button>
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                <button class="btn btn-flat-danger dropdown-toggle mr-1 mb-1"
                                                    type="button" id="dropdownMenuButton400" data-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false">
                                                    Danger
                                                </button>
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                <button class="btn btn-flat-warning dropdown-toggle mr-1 mb-1"
                                                    type="button" id="dropdownMenuButton500" data-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false">
                                                    Warning
                                                </button>
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                <button class="btn btn-flat-light dropdown-toggle mr-1 mb-1"
                                                    type="button" id="dropdownMenuButton600" data-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false">
                                                    Light
                                                </button>
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                <button class="btn btn-flat-dark dropdown-toggle mr-1 mb-1"
                                                    type="button" id="dropdownMenuButton700" data-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false">
                                                    Dark
                                                </button>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                <button class="btn bg-gradient-primary dropdown-toggle mr-1 mb-1"
                                                    type="button" id="dropdownMenuButton101" data-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false">
                                                    Primary
                                                </button>
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                <button class="btn bg-gradient-success dropdown-toggle mr-1 mb-1"
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                <button class="btn bg-gradient-info dropdown-toggle mr-1 mb-1"
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                <button class="btn bg-gradient-danger dropdown-toggle mr-1 mb-1"
                                                    type="button" id="dropdownMenuButton404" data-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false">
                                                    Danger
                                                </button>
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                <button class="btn bg-gradient-warning dropdown-toggle mr-1 mb-1"
                                                    type="button" id="dropdownMenuButton505" data-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false">
                                                    Warning
                                                </button>
                                        ...
                                        <div class="btn-group">
                                            <div class="dropdown">
                                                <button class="btn bg-gradient-dark dropdown-toggle mr-1 mb-1"
                                                    type="button" id="dropdownMenuButton707" data-toggle="dropdown"
                                                    aria-haspopup="true" aria-expanded="false">
                                                    Dark
                                                </button>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <p>
                                            To create dropdown with you can use <code>.btn-lg</code> for large and
                                            <code>.btn-sm</code> for Small with
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <p>
                                            ...
                                            <code>.dropdown-menu-right</code> with your <code>.dropdown-menu</code>. for
                                            drop up use
                                            <code>.dropup</code> as a wrapper. for drop right use
                                            <code>.dropright</code> as wrapper. for
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <p>To create a dropdown with groups you can use <code>.dropdown-header</code> for
                                        the header of groups
                                        and for sepration of group you can use <code>.dropdown-divider</code>.
                                    </p>
                                    <p>
                                        To create a dropdown with icons use class <code>.dropdown-icon-wrapper</code>
                                        with your dropdown
                                        and you class class <code>.dropdown-icon</code> with the default
                                        <code>&lt;i&gt;</code> tag.
                                    </p>
                                    <div class="btn-group dropup mr-1 mb-1">
                                        <button class="btn btn-primary dropdown-toggle" type="button"
                                            id="dropdownMenuButton902" data-toggle="dropdown" aria-haspopup="true"
                                            aria-expanded="false">
                                            Groups
                                        </button>
