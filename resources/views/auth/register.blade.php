...
<head>
    ...
    <title>S'inscrire - SAHLA MAHLA</title>
                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 p-2">
                                        ...
                                        <p class="px-2 text-center">Remplissez le formulaire ci-dessous pour créer un
                                            nouveau
                                            compte.
                                            .</p>
                                                ...
                                                <form method="POST" action="{{ route('register') }}">
                                                    ...
                                                    <div class="form-label-group">
                                                        ...
                                                        <input id="name" type="text"
                                                            class="form-control service-input  @error('name') is-invalid @enderror"
                                                    ...
                                                    <div class="form-label-group">
                                                        <!-- <input type="email" id="inputEmail" class="form-control service-input" placeholder="Email" required> -->
                                                    ...
                                                    <div class="form-label-group">
                                                        <!-- <input type="text" id="inputName" class="form-control service-input" placeholder="Name" required> -->
                                                        <select id="role" type="text"
                                                            class="form-control service-input @error('role') is-invalid @enderror"
                                                            name="role" placeholder="role" value="{{ old('role') }}"
                                                            required autocomplete="role" autofocus>
                                                            <option value="Client">Utilisateur Normal</option>
                                                            <option value="Provider">Fournisseur de Services
                                                            </option>
                                                    ...
                                                    <div class="form-label-group">
                                                        <!-- <input type="password" id="inputPassword" class="form-control service-input" placeholder="Password" required> -->
                                                    ...
                                                    <div class="form-label-group">
                                                        <!-- <input type="password" id="inputConfPassword" class="form-control service-input" placeholder="Confirm Password" required> -->
