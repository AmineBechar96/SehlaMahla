...
<head>
    ...
    <title>Réservations - Client - SAHLA MAHLA</title>
...
<body class="horizontal-layout horizontal-menu 2-columns ecommerce-application navbar-floating footer-static  "
    ...
    <script>
        ...
        window.addEventListener('swal:closeGreatingMessage',function(e){     
            $('#danger2').modal('hide');
        });
        window.addEventListener('swal:showShipperModal',function(e){  
            $('#danger2').modal('hide'); 
            
            $('#shippers').delay(5000 ).modal('show');
        });

         window.addEventListener('swal:closeShipperModal',function(e){  
            $('#shippers').modal('hide');
        });
        window.addEventListener('swal:showConfirmFinish',function(e){  
            $('#danger').modal('show');
        });
        window.addEventListener('report',function(e){     
            $('#report').modal('show');
        });
        window.addEventListener('confirmCancel',function(e){     
            $('#danger').modal('show');
        });
        window.addEventListener('loadUpdatedData',function(e){     
