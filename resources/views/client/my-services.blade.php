...
<head>
    ...
    <title>Mes Services - Client - SAHLA MAHLA</title>
...
<body
    ...
    <div class="app-content content">
        ...
        @livewire('client.selected-service')
    ...
    <!-- END: Page JS-->
    <script src="../../../app-assets/js/scripts/livewireevent.js"></script>
    <!-- END: Page JS-->
