...
<body class="horizontal-layout horizontal-menu 2-columns  navbar-floating footer-static  " data-open="hover"
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body" x-data="handler()">
                                    ...
                                    <div class="card-body">
                                        <form class="form">
                                            <div class="form-body">
                                                ...
                                                <hr>
                                                <h5 class="font-weight-bold mt-2">General Information section</h5>

                                                <template x-for="(field, index) in fields" :key="index">
                                                    <div class="row mt-2" x-model="field.description"
                                                        name="description[]">
                                                        <h6 class="font-weight-bold mb-2 ml-2" x-text="index + 1">
                                                        </h6>
                                                        <div class="col-md-12 col-12">
                                                            <div class="form-group">
                                                                <label class="font-weight-bold"
                                                                    for="country-floating">DESCRIPTION</label>

                                                                <input style="height:50px" type="text"
                                                                    x-bind:name="'description-'+index"
                                                                    x-bind:id="'description-'+index"
                                                        ...
                                                        <div class="col-md-4 col-4">
                                                            <div class="form-group">
                                                                <label class="font-weight-bold"
                                                                    for="last-name-column">PRIX UNITAIRE</label>

                                                                <input style="height:50px" x-bind:name="'price-'+index"
                                                                    id="price-0" type="number" class="form-control"
                                                        ...
                                                        <div class="col-md-4 col-4">
                                                            <div class="form-group">
                                                                <label class="font-weight-bold"
                                                                    for="last-name-column">NOMBRE</label>

                                                                <input style="height:50px" x-bind:name="'number-'+index"
                                                                    id="number-0" type="number" class="form-control"
                                                                    placeholder="Last Name">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 col-4">
                                                            <div class="form-group">
                                                                <label class="font-weight-bold"
                                                                    for="city-column">MONTANT</label>

                                                                <input style="height:50px" disabled type="text"
                                                                    x-bind:name="'ammount-'+index" id="ammount-0"
                                                                    class="form-control" placeholder="City">
                                                            </div>
                                                        ...
                                                        <div class="col-md-6 col-6">
                                                            <button @click.prevent="removeField(index)"
                                                                class="btn btn-danger font-weight-bold"><i
                                                                    class="feather icon-x"></i> RETIRER</button>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row mt-2 mb-5">
                                                    <div class="col-md-4 col-12">
                                                        <button @click.prevent="addNewField()"
                                                            class="btn btn-success font-weight-bold"><i
                                                                class="feather icon-plus"></i> AJOUTER</button>

                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="row mt-2 mb-5" x-data="{ show: false }">
                                                    ...
                                                    <div class="col-md-6 col-6 " x-show="show">
                                                        <div class="form-group ">
                                                            <label class="font-weight-bold"
  ...
  mutations.forEach((mutation) => {
    ...
    if (oldValue !== newValue) {
        let a = document.getElementById("price-0");
let b = document.getElementById("number-0");
let total = document.getElementById("ammount-0");

let price1 = document.getElementById("price-0");
let price2 = document.getElementById("number-0");
