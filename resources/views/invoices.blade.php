                ...
                <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active" data-menu=""><a class="dropdown-item" href="table-datatable.html"
                                ...
                                <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        <div class="row justify-content-center">
                                            <div class="col-md-8 col-12 "><button
                                                    class="btn btn-block btn-primary font-weight-bold round"><i
                                                        class="feather icon-plus"></i>
                                                    AJOUTER FACTURE</button></div>
                                        </div>
                                        <div class="table-responsive">
                                            <table class="table zero-configuration">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="text-primary font-weight-bold">00056889</td>
                                                        <td>2011/06/27</td>
                                                        <td>Deboub Halim</td>
                                                        <td>0558472551</td>
                                                        <td>$183,000</td>
                                                        <td class="text-danger font-weight-bold">Non Payé</td>
                                                        <td>
                                                            <div class="d-flex justify-content between">
                                                                <i
                                                                    class="feather icon-edit pr-1 text-success cursor-pointer"></i>
                                                                <i
                                                                    class="feather icon-trash pr-1 text-danger cursor-pointer"></i>
                                                                <i
                                                                    class="feather icon-eye text-primary cursor-pointer"></i>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>0558472551</td>
                                                        <td>$183,000</td>
                                                        <td class="text-success font-weight-bold">Payé</td>
                                                        <td>
                                                            <div class="d-flex justify-content between">
                                                                <i
                                                                    class="feather icon-edit pr-1 text-success cursor-pointer"></i>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>0558472551</td>
                                                        <td>$183,000</td>
                                                        <td class="text-warning font-weight-bold">Parciellement Payé
                                                        </td>
                                                        <td>
                                                            <div class="d-flex justify-content between">
                                                                <i
                                ...
                                <div class="card-content">
                                    <div class="card-body card-dashboard">
                                        <div class="row float-right">
                                            <div class=""><button class=" btn btn-primary font-weight-bold "><i
                                                        class="feather icon-plus"></i>
                                                    AJOUTER FACTURE</button> </div>
                                        </div>
                                        <div class="table-responsive">
