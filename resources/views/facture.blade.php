                            ...
                            <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active" data-menu=""><a class="dropdown-item"
                                            href="component-buttons-basic.html" data-toggle="dropdown"
                                            data-i18n="Buttons"><i class="feather icon-circle"></i>Buttons</a>
                                    </li>
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                <section id="basic-button-icons " style="margin-top:90px;">
                        ...
                        <div class="col-lg-4 col-sm-8 ">
                            <div class="card">
                                <div class="card-header justify-content-center d-flex flex-column">
                                    ...
                                    <h6 class="card-title font-medium-2 ">Ajouter Les Paramètres par Defaults
                                    </h6>
                                    <p>Inserer les Information Qui Sont reliées a votre service </p>
                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row match-height">
                                            <div class="col-12 text-center">
                                                ...
                                                <button type="button"
                                                    class="btn btn-primary font-weight-bold mr-1 mt-2 mb-5"
                ...
                <section id="basic-button-icons " style="margin-top:90px;">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-sm-8 ">
                            <div class="card">
                                <div class="card-header justify-content-center d-flex flex-column">
                                    <div class="avatar bg-warning mb-2">
                                        <span class="avatar-content" style="width:50px; height:50px;"><i
                                                class="avatar-icon feather icon-plus font-medium-5"></i></span>

                                    </div>
                                    <h6 class="card-title font-medium-2 ">Ajouter Votre Première Facture
                                    </h6>
                                    ...
                                    <div class="card-body">
                                        <div class="row match-height">
                                            <div class="col-12 text-center">
                                                ...
                                                <button type="button"
                                                    class="btn btn-warning font-weight-bold mr-1 mt-2 mb-5"
                                                    style="height:47px; border-radius:40px" data-toggle="modal"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="text-center mb-3">
                                ...
                                <h4 class="font-weight-bold">Ajouter Details</h4>
                            </div>
                            <form class="form">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <h6 class="font-weight-bold ml-1 mb-2">Quel est Votre Service ?</h6>
                                            <fieldset class="form-group">
                                                <select class="custom-select" style="height:41px" id="customSelect">
                                                    <option selected>Medecin Halim</option>
                                        ...
                                        <div class="col-6">
                                            <h6 class="font-weight-bold ml-1 mb-2">Comment Vous Travailez ?</h6>
                                            <fieldset class="form-group">
                                                <select class="custom-select" style="height:41px" id="customSelect">
                                                    <option selected>Jour</option>
                                                    <option value="IT">Heure</option>
                                                    <option value="Blade Runner">Piéce</option>
                                                    <option value="Blade Runner">Tache</option>
                                                    <option value="Blade Runner">Visite</option>
                                                    <option value="Blade Runner">Operation</option>
                                                    <option value="Thor Ragnarok">Mètre</option>
                                                    <option value="Thor Ragnarok">Kilograme</option>
                                                </select>
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="form-label-group position-relative has-icon-left">
                                                <input type="number" id="contact-floating-icon" class="form-control"
                                                    style="height:41px" name="contact-floating-icon"
                                        ...
                                        <div class="col-6">
                                            <div class="form-label-group position-relative has-icon-left">
                                                ...
                                                <label for="contact-floating-icon">Prix Unitaire</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-label-group position-relative has-icon-left">
                                                ...
                                                <textarea class="form-control" name="ServiceBody" id="accountTextarea"
                                                    rows="3" placeholder="Entrer votre description ..."></textarea>
                                                <div class="form-control-position">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body mt-75">
                                                        <div
                                                            ...
                                                            <input type="file" name="ServiceImage" id="account-upload"
                                                                hidden>
                                                            <button
                        ...
                        <div class="modal-footer d-flex justify-content-center">
                            ...
                            <button type="button" style="border-radius: 40px" class="btn btn-primary font-weight-bold"
                            ...
                            <form class="form">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <h6 class="font-weight-bold ml-1 mb-2">Information de Produit ou (Travail) ?
                                            </h6>
                                        ...
                                        <div class="col-6">
                                            <div class="form-label-group position-relative has-icon-left">
                                                <input type="number" id="password-floating-icon" class="form-control"
                                                    style="height:41px" name="password-floating-icon" placeholder="TVA">
                                                <div class="form-control-position">
                                                    <i class="feather icon-percent"></i>
                                                </div>
                                                <label for="password-floating-icon">TVA</label>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-label-group position-relative has-icon-left">
