                                ...
                                <div class="card-content">
                                    <div class="card-body actions">
                                        ...
                                        <p>
                                            ...
                                            1)
                                            <i class="feather icon-user mr-1"></i> Client Fidèle
                                            @else
                                            <i class="feather icon-star mr-1"></i> Nouveau Client
                                            @endif
                                        ...
                                        <div class="btn btn-primary btn-block delivery-address"><a style="color:white"
                                                href="{{url('provider/users-list')}}"><i class="feather icon-eye "></i>
                                                VOIR LISTE DES CLIENTS</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
