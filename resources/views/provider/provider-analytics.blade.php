...
<head>
    ...
    <title>Statistiques - Fournisseur - SAHLA MAHLA </title>
...
<body class="horizontal-layout horizontal-menu 2-columns  navbar-floating footer-static  " data-open="hover"
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <p class="mb-1 font-weight-bold">Abonnées
                                    </p>
                                </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    <div class=" p-50 m-0">
                                        <div class="avatar-content">
                                            <img src="../../../app-assets/images/icons/sales.png"
                                                style="width:33px; height:33px;" alt="">
                                        </div>
                                    </div>
                                    <h2 class="text-bold-700 mt-1">{{$totall}}</h2>
                                    <p class="mb-2 font-weight-bold">Ventes</p>
                                </div>
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex flex-column align-items-start pb-0">
                                    ...
                                    <h2 class="text-bold-700 mt-1">{{count($clients)}}</h2>
                                    <p class="mb-1 font-weight-bold">Clients</p>
                                </div>
                                        ...
                                        <ul class="activity-timeline timeline-left list-unstyled">
                                            <li>
                                                ...
                                                <div class="timeline-info">
                                                    ...
                                                    <span class="font-small-3">2 points pour chaque réservation
                                                        terminée</span>
                                                </div>
                                                <small
                                            ...
                                            <li>
                                                ...
                                                <div class="timeline-info">
                                                    <p class="font-weight-bold mb-0">Refus de réservation
                                                    </p>
                                                    <span class="font-small-3">-1 points pour chaque réservation
                                                        réfusée</span>
                                                </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="timeline-info">
                                                    <p class="font-weight-bold mb-0">Coupones et réductions
                                                    </p>
                                                    <span class="font-small-3">coupones pour les clients fidéles</span>
                                                </div>
                                                <small
                                                    class="text-muted">{{auth()->user()->points->updated_at->diffForHumans()}}</small>
                                            </li>
  ...
  var productChartoptions = {
    ...
    @if(count($booking)>0)
    series: [{{round((count($completed)*100)/count($booking))}}, {{round((count($pending)*100)/count($booking))}},{{round((count($ongoing)*100)/count($booking))}}, {{round((count($rejected)*100)/count($booking))}}],
