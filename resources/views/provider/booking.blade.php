...
<body class="horizontal-layout horizontal-menu 2-columns ecommerce-application navbar-floating footer-static  "
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                @livewire('provider.booking-notification',['id' => $booking_id,'notif'=>$notif_id])
    ...
    @livewireScripts
    <script>
        window.addEventListener('swal:BookingAcceptedPendingFromNotification',function(e){     
            $('#NotifyClientAcceptPendingFromNotification').modal('show');
        });
