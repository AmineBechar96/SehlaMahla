                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    ...
                                    <h1 class="font-large-2 my-2">Service Indisponible</h1>
                                    <p class="p-2">
                                        ce service est temporairement arrêté ou suspendu, nous vous recommandons de
                                        revoir cette page dans les prochaines occasions.
                                    </p>
                                    <a class="btn btn-primary btn-lg mt-2" href="{{url()->previous()}}">Back to Home</a>
                                </div>
                            </div>
                        </div>
                    </div>
