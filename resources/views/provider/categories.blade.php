                        ...
                        <div class="col-xl-3 col-md-4 col-sm-6">
                            <div class="card text-center">
                                <div class="card-content">
                                    <div class="card-body">
                                        <img class="img-fluid rounded mt-1 mb-1 " width="100" height="100"
                                            src="../../../app-assets/images/categories/{{$category->icon_name}}.png"
                                            alt="img placeholder">
                                        <a href="{{url('provider/'.$category->id.'/types')}}">
                                            <h3 class="text-bold-700">{{trans('categories.'.$category->name)}}</h3>
                                            <p class="mb-0 line-ellipsis">sahla mahla</p>
                                        </a>
                                    </div>
                                </div>
                            </div>
